<body class="bg-white text-dark font-sans">
  <header class="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-borderGrey">
    <div class="container mx-auto px-4 h-20 flex items-center justify-between">
      <!-- Logo -->
      <a href="/" class="text-2xl font-teko font-bold uppercase tracking-tighter text-dark">
        Dwarka<span class="text-primary text-3xl">Expressway</span>
      </a>
      <!-- Desktop Nav -->
      ...
      <a
        ...
        class="inline-block bg-primary text-white md:px-6 px-2 py-2.5 font-bold text-sm uppercase hover:bg-black transition">
        Inquire Now
      </a>
      <!-- Mobile Menu Button -->
    ...
    <!-- Mobile Menu -->
    <div id="mobileMenu" class="md:hidden hidden bg-white border-t border-borderGrey">
